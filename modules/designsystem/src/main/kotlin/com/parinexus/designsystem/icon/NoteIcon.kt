package com.parinexus.designsystem.icon
...
import com.parinexus.designsystem.R
...
object NoteIcon {
    ...
    val background = listOf(
        NoteBg(Color(0xFF737D55), R.drawable.designsystem_asset_1),
        NoteBg(Color(0xFFDB69A3), R.drawable.designsystem_asset_2),
        NoteBg(Color(0xFFB80D57), R.drawable.designsystem_asset_3),
        NoteBg(Color(0xFFC26744), R.drawable.designsystem_asset_4),
    )
