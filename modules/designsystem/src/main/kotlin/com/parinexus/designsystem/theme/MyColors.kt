package com.parinexus.designsystem.theme
...
sealed class MyColors {
    ...
    data object Default : MyColors() {
        ...
        override val primaryLight = Color(0xFF3384F9)
        override val onPrimaryLight = Color(0xFFFFFFFF)
        override val primaryContainerLight = Color(0xFF3384F9)
        override val onPrimaryContainerLight = Color(0xFFFFFFFF)
        override val secondaryLight = Color(0xFF77574B)
        override val onSecondaryLight = Color(0xFFFFFFFF)
        override val secondaryContainerLight = Color(0xFFFFFFFF)
        ...
        override val backgroundLight = Color(0xFFEFF0F4)
        override val onBackgroundLight = Color(0xFF231A16)
        override val surfaceLight = Color(0xFFEFF0F4)
        ...
        override val outlineLight = Color(0xFFD0D1D4)
        override val outlineVariantLight = Color(0xFFD0D1D4)
        override val scrimLight = Color(0xFF000000)
        override val inverseSurfaceLight = Color(0xFFCBDEFB)
        ...
        override val surfaceBrightLight = Color(0xFFEFF0F4)
        override val surfaceContainerLowestLight = Color(0xFFFFFFFF)
        override val surfaceContainerLowLight = Color(0xFFFFF1EC)
        override val surfaceContainerLight = Color(0xFFEFF0F4)
        override val surfaceContainerHighLight = Color(0xFFEFF0F4)
        override val surfaceContainerHighestLight = Color(0xFFEFF0F4)

        override val primaryDark = Color(0xFFFFB598)
        override val onPrimaryDark = Color(0xFF0F44A6)
        override val primaryContainerDark = Color(0xFF71361C)
        override val onPrimaryContainerDark = Color(0xFF145E3A)
        ...
        override val onSecondaryContainerDark = Color(0xFFB9B328)
        ...
        override val outlineDark = Color(0xFFD0D1D4)
        override val outlineVariantDark = Color(0xFFD0D1D4)
    ...
    data object Pink : MyColors() {
        ...
        override val primaryDark = Color(0xFF1F2023)
